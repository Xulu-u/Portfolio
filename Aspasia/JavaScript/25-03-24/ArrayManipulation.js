...
const collectByName2 = (characterName) => {
    ...
    if (collectedCharacters2.some(character => character.name === characterName)) {
        collectedCharacters2.find(character => character.name === characterName).amount++;
    }
    else collectedCharacters2.push(amount = 0, ...char)
}
